...
ADJUST: README.md for clarity and cohesion. - 03/30/26

CHECK: ASNMAP Logic for errors??? It might have errors if no API key is initialized. - 03/27/26
...
ADD: Progress bar/status thing so you can see if it hangs. - 03/31/2026

REBASE: Maybe Go? C++? Python? INTERCAL? - 03/30/26
